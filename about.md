...
If I could sum up my learnings as a designer so far, the key takeaway I’ve learnt is to **fail often and fail fast**. Ask all the questions. Say all the things. Don’t over think it. Listen to feedback. Take action. Design is an evolving process of iteration, collaboration, feedback, testing and **solving problems**. 
